...
export default function ProgramsPage() {
  ...
  const handleWheel = useCallback(
    (event: React.WheelEvent<HTMLDivElement>) => {
      ...
      const sections = Array.from(container.querySelectorAll<HTMLElement>("[data-program-snap='true']"));
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <Button asChild size="lg" className="gap-2">
                    ...
                    >
                    {/* Linux 로고 SVG */}
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-tux" viewBox="0 0 16 16">
        ...
        {programs.map((program, index) => {
          ...
          return (
            <button
              ...
              aria-label={t("paginationItem", { title: t(`items.${program.key}.title`) })}
